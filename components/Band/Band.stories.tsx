...
const sampleItems = [
  {
    ...
    content:
      "Bold in our thinking and fearless in our decisions, we are empowered to seize opportunities and deliver results.",
    image: {
  ...
  },
  {
    ...
    content:
      "Proud of our business, we are inspired to share our best with each other and our customers.",
    image: {
  ...
  },
  {
    ...
    content:
      "We challenge conventional thinking and never stop looking for ways to improve ourselves and our customer experience.",
    image: {
  ...
  },
  {
    ...
    content:
      "We think of our customer in all that we do to add real value and deliver on our Purpose.",
    image: {
