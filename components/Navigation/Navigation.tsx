...
export const Navigation = ({
  ...
  links,
  isNavigationVisible,
  isLogoVisible: isLogoVisibleProp,
}: NavigationProps) => {
  const { setRef, sticky, stuck, fixed, isOpen, toggle, isLogoVisible: isLogoVisibleCtx } =
    useNavigationContext();
  const isLogoVisible = isLogoVisibleProp ?? isLogoVisibleCtx;
