...
export const metadata: Metadata = {
	...
	metadataBase: new URL(process.env.NEXT_PUBLIC_BASE_URL || "https://searchpartyottawa.ca"),
	robots: "follow, index",
	verification: {
	...
	return (
		<html lang="en" suppressHydrationWarning>
			<head>
				...
				<link rel="mask-icon" href="/static/favicons/safari-pinned-tab.svg" color="#FF6000" />
			</head>
			<body>
				<Providers>
